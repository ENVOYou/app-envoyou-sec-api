...
export const DashboardIcon = ({ className = "", ...props }: IconProps) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`w-6 h-6 ${className}`} {...props}>
...
export const GoogleIcon = ({ className = "", ...props }: IconProps) => (
  <svg viewBox="0 0 24 24" fill="currentColor" className={`w-6 h-6 ${className}`} {...props}>
