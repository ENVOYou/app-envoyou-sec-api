...
export const KeyIcon = ({ size = 20, ...props }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const SettingsIcon = ({ size = 20, ...props }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="m15.5 3.5-1 1 1 1 1-1-1-1"/>
    <path d="m13 17.5-1 1 1 1 1-1-1-1"/>
    <path d="M5.5 7.5 4 6l4-4 1.5 1.5-4 4"/>
    <path d="M18.5 16.5 20 18l-4 4-1.5-1.5 4-4"/>
    <path d="m7.5 4.5-1-1L8 2l1.5 1.5L8 5"/>
    <path d="m16.5 19.5-1-1 1.5-1.5L18 16l1.5 1.5-1.5 1.5"/>
  </svg>
)
...
export const MoonIcon = ({ size = 20, ...props }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
